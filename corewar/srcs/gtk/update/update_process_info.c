...
/*   Updated: 2017/09/19 20:08:57 by wescande         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_process_info(t_vm *vm)
{
	...
	gtk_label_set_text(GTK_LABEL(vm->gtk.panel.p_win.main_label), vm->gtk.panel.process->last_live ? STATUS_ALIVE : STATUS_NEW);
	i = -1;
	while (++i < REG_NUMBER)
	{
